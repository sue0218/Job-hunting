...
const isPublicRoute = createRouteMatcher(['/', '/sign-in(.*)', '/sign-up(.*)', '/api/webhooks(.*)', '/api/cron(.*)', '/api/og(.*)', '/opengraph-image(.*)', '/sitemap.xml', '/robots.txt', '/beta', '/invite(.*)', '/privacy', '/terms', '/tokushoho', '/guides(.*)', '/diagnose(.*)'])
const publicPaths = ['/', '/sign-in', '/sign-up', '/api/webhooks', '/api/cron', '/api/og', '/opengraph-image', '/sitemap.xml', '/robots.txt', '/beta', '/invite', '/privacy', '/terms', '/tokushoho', '/guides', '/diagnose']
